...
public class ParamParser {
	...
	private static Logger logger  =  Logger.getLogger("[交易接口]:[变量解释]");
	 ...
	 * @return
	 */
	public final static String parseVariable(String str,UniKeyValueObject vv,ResultSet rs){	

		int normalIndex = -1;
		int fieldIndex = -1;
		List normalVariable = new ArrayList();
		List fieldVariable  = new ArrayList();
