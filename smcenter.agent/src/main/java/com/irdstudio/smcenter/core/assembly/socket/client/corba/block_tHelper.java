...
abstract public class block_tHelper
{
  private static String  _id = "IDL:block_t:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (block_tHelper.id (), "block_t", __typeCode);
    }
    return __typeCode;
  }
