...
public class BeanUtilsBean {
    ...
    public BeanUtilsBean(
    	...
    	convertUtilsBean.register(new org.apache.commons.beanutils.converters.BigDecimalConverter(null), BigDecimal.class);
        convertUtilsBean.register(new org.apache.commons.beanutils.converters.DateConverter(null), java.util.Date.class);
        ...
        convertUtilsBean.register(new org.apache.commons.beanutils.converters.SqlTimeConverter(null), java.sql.Time.class);
